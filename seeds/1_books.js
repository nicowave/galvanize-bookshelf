  ...
  return knex('books').del()
    .then(function () {
        // Inserts seed entries
          ...
          // if inserting into this table 'start' at the last 'id' value and increment from there
          // this 'raw' (in referecne to SQL to Knex) query gets the maximun id value and sets the 'books_id_seq' to this value
          // such that inserting a new object or row to the database does not duplicate any id key-value pairs
          .then(function() {
